    ...
    <div className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-200">
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          <a href="/" className="text-xl font-bold text-gray-900">CloudSolution</a>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="/get-started" className="btn bg-indigo-600 hover:bg-indigo-700 text-white border-0">
              Get Started
            </a>
          </div>
        </div>
